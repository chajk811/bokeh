...
def update_plot(attrname, old, new):
    global layout
    # global sensor_id, sensor_kind, axis_kind
...
## 문제 해결 참고
## https://stackoverflow.com/questions/45962909/source-data-is-updated-in-bokeh-serve-but-plot-does-not-change
## https://github.com/bokeh/bokeh/blob/master/examples/app/crossfilter/main.py